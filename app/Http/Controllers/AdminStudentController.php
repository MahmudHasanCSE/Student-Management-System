...
class AdminStudentController extends Controller
{
    ...
    public function updateStatus($id)
    {
        ...
        if ($this->student->status == 1)
        {
            ...
            $this->message = "Student Information Inactive Successfully!";
        } else {
            $this->student->status = 1;
            $this->message = "Student Information Active Successfully!";
        }
        $this->student->save();
    ...
    public function updateEnrollStatus($id)
    {
        ...
        return redirect()->back()->with('message', 'Student enroll status information updated successfully!');
    }
}
