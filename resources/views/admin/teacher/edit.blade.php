                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update-teacher', ['id' => $teacher->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{$teacher->name}}" name="name" class="form-control" id="horizontal-fullname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Update Teacher Information</button>
                                </div>
                            </div>
                        </div>
                    </form>
